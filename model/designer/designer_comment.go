...
type DesignerComment struct {
	...
	HouseType      int    `json:"house_type" gorm:"default:0;comment:房屋类型"`      // 房屋类型:0(默认)|毛胚1|精装2|老房3
	DecorationMode int    `json:"decoration_mode" gorm:"default:0;comment:装修方式"` // 装修方式:0(默认)|全包1|半包2|清包3
	HouseArea      int    `json:"house_area" gorm:"default:0;comment:房屋面积"`      // 房屋面积
	TotalCost      int    `json:"total_cost" gorm:"default:0;comment:总花费"`       // 总花费
